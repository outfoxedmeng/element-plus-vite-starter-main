...
<template>
  ...
  <div class="my-2 text-center flex flex-wrap justify-center items-center">
    <el-button @click="increament">count is: {{ count }}</el-button>
    <el-button type="primary" @click="increament"
      >count is: {{ count }}</el-button
    >
    <el-button type="success" @click="increament"
      >count is: {{ count }}</el-button
    >
    <el-button type="warning" @click="increament"
      >count is: {{ count }}</el-button
    >
    <el-button type="danger" @click="increament"
      >count is: {{ count }}</el-button
    >
    <el-button type="info" @click="increament">count is: {{ count }}</el-button>
  </div>
